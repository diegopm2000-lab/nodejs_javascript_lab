...
const log = require('./logger/applicationLogger.gateway');
...
const TOKEN_NOT_RECEIVED = 'Token de Autorización no recibido';
const TOKEN_NOT_VALID_OR_EXPIRED = 'Token no válido o caducado';
const INTERNAL_ERROR = 'Error interno en la validación del token';
